      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="assets/img/poto.jpeg" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2">Mutia</span>
    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-8">
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card attendance-card" style="background-color: #b3e5fc;">
        ...
        <!-- Absence Card -->
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card absence-card" style="background-color: #ffcdd2;">
        ...
        <li><a class="dropdown-item" href="#">This Year</a></li>
          ...
          <div class="card-body">
        <h5 class="card-title">Absence <span>| Today</span></h5>
